            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <form action="<?php echo e(route('departamentos.update',$department->id )); ?>" method="POST" class="form-group">
                        ...
                        <?php echo $__env->make('areas.departamentos.partials.form',
                        ['department',
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bernacantun/Documents/Proyectos/Laravel/sc_hae/resources/views/areas/departamentos/edit.blade.php ENDPATH**/ ?>