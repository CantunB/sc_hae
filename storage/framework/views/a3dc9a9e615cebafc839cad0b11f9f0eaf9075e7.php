                    ...
                    <div class="col-sm-6">
                        <div class="text-sm-left">
                            <?php if($purchaseorder->status <= 1): ?>
                                ...
                                <a class="btn btn-sm btn-soft-danger waves-effect waves-light mb-2" href="<?php echo e(route('pdf.order_gt', $purchaseorder->id)); ?>" target="_blank"><i class="mdi mdi-printer" ></i> Imprimir</a>
                            ...
                            <div class="container">
                                ...
                                <div class="row justify-content-start">
                                    <div class="col-md-6">
                                        ...
                                        &nbsp;&nbsp;&nbsp;<span><?php echo e($purchaseorder->detail->coordination); ?></span>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row justify-content-start">
                                    <div class="col-md-6">
                                        ...
                                        &nbsp;&nbsp;&nbsp;<span><?php echo e($purchaseorder->detail->department); ?></span>
                                    </div>
                                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bernacantun/Documents/Proyectos/Laravel/sc_hae/resources/views/compras/ordenes/purchaseorder.blade.php ENDPATH**/ ?>