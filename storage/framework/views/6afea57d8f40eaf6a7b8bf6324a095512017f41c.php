        ...
        <div class="card-box">
          <!---  <h4 class="header-title">Borderless table</h4>
            ...
            <div class="table-responsive">
                <form action="<?php echo e(route('roles.update', $roles->id)); ?>" method="POST" class="form-group">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bernacantun/Documents/Proyectos/Laravel/sc_hae/resources/views/settings/roles/edit.blade.php ENDPATH**/ ?>