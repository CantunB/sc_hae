        ...
        <div class="card">
            <div class="card-body">
                <div class="row mb-2">
                    ...
                    <form id="form" method="POST" action="<?php echo e(route('request.update', $requisition->requisition_id)); ?>">
                        <?php echo method_field('PUT'); ?>
                        <?php echo csrf_field(); ?>
                        <?php if(is_null($requisition->requisition->file_req)): ?>
                            <div class="alert alert-<?php echo e($requisition->requisition->status  == 0 ? 'success' : 'danger'); ?> border-0">
                                <div class="form-group row col-md-12">
                                    <label><i class="mdi mdi-alert-circle-outline mr-2"></i>SELECCIONAR EL ESTADO DE LA REQUISICION</label>
                                    <div class="col-md-4">
                                        <select type="text" name="status" class="form-control select2" data-style="btn-outline-primary" >
                                                <option value="0" <?php if($requisition->requisition->status == 0): ?>selected <?php endif; ?> >Autorizada</option>
                                                <option value="2" <?php if($requisition->requisition->status == 2): ?>selected <?php endif; ?> >No Autorizada</option>
                                        </select>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/bernacantun/Documents/Proyectos/Laravel/sc_hae/resources/views/requisitions/request/edit.blade.php ENDPATH**/ ?>