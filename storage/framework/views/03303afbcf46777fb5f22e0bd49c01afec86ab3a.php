<html>
<head>
    <title> <?php echo e($order->detail->order_folio ?? 'Orden de Compra'); ?> </title>
    <style>
        @page  {
            margin: 0cm 0cm;
            font-family: Arial;
    ...
    <div class="container">
                        ...
                        <div class="container">
                            <div class="row">
                                <p>
                                    ...
                                    <?php echo e($order->detail->order_folio ?? 'sin orden'); ?>
                            ...
                            <div class="row">
                                <p>
                                    ...
                                    <?php echo e(Carbon\Carbon::parse($order->detail->created_at)->format('d/m/Y') ?? 'sin orden'); ?>
                        ...
                        <div class="container">
                            <p  style="text-align: start">
                                <strong>CON FUNDAMENTO EN EL NUMERAL 39, 41, 43, 45 Y DEMÁS RELATIVOS APLICABLES DE LA LEY DE ADQUISICIONES, ARRENDAMIENTOS Y PRESTACIÓN <br>
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <?php echo e($order->detail->requisition->folio ?? 'sin orden'); ?>
                        ...
                        <div class="col-md-12" >
                            <p style="text-align: start">
                                <strong> Proveedor: </strong>
                                        <?php echo e($order->detail->provider->name ?? 'sin orden'); ?>

                                    <br>
                                <strong> Coordinacion: </strong>
                                        <?php echo e($order->coordination->name ?? 'sin orden'); ?>

                                    <br>
                                <strong> Departamento: </strong>
                                        <?php echo e($order->department->name ?? 'sin orden'); ?>
        ...
        <table style="width: 100%; height: 122px;" border="1">
            ...
            <?php $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tbody>
                <tr>
                    <td style="font-size: 10px; text-align: center "><?php echo e($material->material->departure); ?></td>
                    <td style="font-size: 10px; text-align: center "><?php echo e($material->material->quantity); ?></td>
                    <td style="font-size: 10px; text-align: center "><?php echo e($material->material->unit); ?></td>
                    <td style="font-size: 10px; text-align: start "><?php echo e($material->material->concept); ?>
                ...
                <tr style="height: 18px;">
                    ...
                    <td style="width: 50%; height: 18px;font-size: x-small;border:none">
                        <div class="container">
                            <p>
                                <strong>
                                    <?php echo e($purchaseorder->purchasorder->feauture->delivery_time ?? 'N/A'); ?> <br>
                                </strong>
                                <strong>
                                    <?php echo e($purchaseorder->purchasorder->feauture->existence ?? 'N/A'); ?> <br>
                                </strong>
                                <strong>
                                    <?php echo e($purchaseorder->purchasorder->feauture->payment_method ?? 'N/A'); ?> <br>
                                </strong>
                                <strong>
                                    <?php echo e($purchaseorder->purchasorder->feauture->price_term ?? 'N/A'); ?> <br>
                                </strong>
                                <strong>
                                    <?php echo e($purchaseorder->purchasorder->feauture->other ?? 'N/A'); ?> <br><br>
                                </strong>
                                
                                <label>
                                    <strong>
                                        <?php echo e($purchaseorder->purchasorder->feauture->program ?? 'N/A'); ?> <br>
                                    </strong>
                                    <strong>
                                        <?php echo e($purchaseorder->purchasorder->feauture->application ?? 'N/A'); ?><br>
                                    </strong>
                                    <strong>
                                        <?php echo e($purchaseorder->purchasorder->feauture->vehicle ?? 'N/A'); ?> <br>
                                    </strong>
                                </label>
                            </p>
                        </div>
...
<?php /**PATH /Users/bernacantun/Documents/Proyectos/Laravel/sc_hae/resources/views/pdf/purchase_order.blade.php ENDPATH**/ ?>